        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          <div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <div className="text-sm text-gray-400">Intelligence with Empathy</div>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><a href="/#product" className="hover:text-white transition-colors">ConvertWise</a></li>
              <li><a href="#" className="hover:text-white transition-colors">DigitalPatron AI</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li>
                <a href="mailto:hello@convertwise.site" className="flex items-center gap-2 hover:text-white transition-colors">
                  <Mail size={18} />
                  <span>hello@convertwise.site</span>
                </a>
              </li>
              <li>
                <a href="tel:+919915494146" className="flex items-center gap-2 hover:text-white transition-colors">
                  <Phone size={18} />
